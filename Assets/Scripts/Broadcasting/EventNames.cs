...
public class EventNames {
	...
	public class StarFighter {
		public const string ON_FIRE_FIRE_BLASTER = "ON_FIRE_FIRE_BLASTER";
		public const string ON_FIRE_STOP_BLASTER = "ON_FIRE_STOP_BLASTER";
		public const string RING_ENTERED = "RING_ENTERED";
		public const string FINAL_RING_CROSSED = "FINAL_RING_CROSSED";
	}
}
